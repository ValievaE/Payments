        ...
        mBtnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MainActivity.this, "Оплата картой " + edTxInputMoney + " " + edTxInputInfo, Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(MainActivity.this, "С мобильного телефона " + edTxInputMoney + " " + edTxInputInfo, Toast.LENGTH_LONG).show();
                else Toast.makeText(MainActivity.this, "Наличными " + edTxInputMoney + " " + edTxInputInfo, Toast.LENGTH_LONG).show();
            }
        });
